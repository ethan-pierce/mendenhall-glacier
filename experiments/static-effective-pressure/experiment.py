...
plt.savefig('./experiments/static-effective-pressure/outputs/fringe_spinup.png')
plt.close()

imshow_grid(BIS.grid, 'dispersed_layer_thickness')
plt.title('Dispersed layer thickness (m) after spin-up (25 years)')
plt.savefig('./experiments/static-effective-pressure/outputs/dispersed_spinup.png')
plt.close()
